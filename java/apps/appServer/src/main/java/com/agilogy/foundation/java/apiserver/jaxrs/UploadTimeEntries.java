...
public class UploadTimeEntries {
  private final HandlebarsTemplates handlebarsTemplates;

  public UploadTimeEntries(HandlebarsTemplates handlebarsTemplates) {
    this.handlebarsTemplates = handlebarsTemplates;
  }


  @GET
  public Response uploadTimeEntriesForm() {
    return Response.ok(handlebarsTemplates.render("uploadTimeEntriesForm.html")).build();
  }
